...
The economic layer extends classical and neoclassical growth concepts into an AI-native coordination model.
...
This repository is public-safe by design. Do not add secrets, wallet keys, private prompts, client data, internal monetization strategy, unreleased canon, or production security logic.

Agentropolis names, lore, visual identity, and trademarks are not licensed for reuse unless explicitly stated.

## License

Apache-2.0 for code, schemas, and documentation unless otherwise noted.
